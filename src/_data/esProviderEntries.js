// Spanish provider pages are opt-in per provider: a provider only gets a
// /es/<key>/ page once a real, translated article exists at
// src/_includes/content/es/<key>.njk. This scans for those files instead
...
module.exports = () => {
  const contentDir = path.join(__dirname, "..", "_includes", "content", "es");
